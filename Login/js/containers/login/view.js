...
import {Input, Link, Form, Modal,CountryCodePicker, ModalTrigger, SocialSignIn} from '@core-components';
        ...
        formElements = [
            {
                ...
                customElement: (
                    <CountryCodePicker
                        style = {{
                            value : stylesObj.countryCodeLabel,
                            label : stylesObj.countryCodeLabel,
